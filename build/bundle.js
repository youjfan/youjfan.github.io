...
var app = (function () {
    ...
    // (42:3) {#if app.apkDirectDl != undefined}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			a = element("a");
    			t = text("Direct download (Android)");
    			attr_dev(a, "href", /*app*/ ctx[3].apkDirectDl);
    			add_location(a, file, 43, 4, 1032);
    			add_location(li, file, 42, 3, 1023);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(42:3) {#if app.apkDirectDl != undefined}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	let t8;
    	let hr;
    	let if_block = /*app*/ ctx[3].apkDirectDl != undefined && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			li = element("li");
    			a1 = element("a");
    			t7 = text("Google Play Store");
    			t8 = space();
    			hr = element("hr");
    			add_location(br0, file, 30, 2, 814);
    			add_location(br1, file, 31, 2, 821);
    			...
    			add_location(img, file, 33, 3, 853);
    			attr_dev(a0, "href", /*app*/ ctx[3].psLink);
    			add_location(a0, file, 32, 2, 828);
    			add_location(h4, file, 39, 2, 954);
    			add_location(br2, file, 46, 3, 1109);
    			attr_dev(a1, "href", /*app*/ ctx[3].psLink);
    			attr_dev(a1, "target", "_blank");
    			add_location(a1, file, 48, 4, 1126);
    			add_location(li, file, 47, 3, 1117);
    			add_location(ul, file, 40, 2, 977);
    			add_location(hr, file, 55, 2, 1225);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (/*app*/ ctx[3].apkDirectDl != undefined) if_block.p(ctx, dirty);
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 24, 1, 647);
    			add_location(h3, file, 25, 1, 720);
    			add_location(br0, file, 26, 1, 779);
    			add_location(br1, file, 27, 1, 785);
    			attr_dev(main, "class", "svelte-y1gqua");
    			add_location(main, file, 23, 0, 639);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
